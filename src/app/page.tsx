  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[15px] row-start-2 items-center sm:items-start">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            ...
            href="https://github.com/martymarkenson/next-js-sqlite-boiler-plate/generate"
            target="_blank"
          ...
          <a
            ...
            href="https://github.com/martymarkenson/next-js-sqlite-boiler-plate/blob/main/README.md"
            target="_blank"
            rel="noopener noreferrer"
          > 
            Read the docs
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        ...
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
          href="https://martymarkenson.com?utm_source=next-js-sqlite-boiler-plate"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
